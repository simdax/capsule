...
class OscMessage(object):
 ...
 #   help("size", self.size)
  ...
  def _parse_datagram(self):
    ...
    # |||||| on veux ce truc coter "server"-> ceului aui recoit le signal
    # vvvvvv pour les transmettre au truc qui sayvgarde et tout
 #   print("the role", osc_role.am_i_serveur())
  #  if (osc_role.am_i_serveur() == True):
  #  print("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ address:", self.address,"   value:", val) # <-- mais ca ca s'execute pou les deux
